...
from .modules.cross_view_hybrid_attention import TPVCrossViewHybridAttention,CustomPositionalEncoding
...
class TPVFormerHead(BaseModule):
    ...
    def __init__(self,
        ...
        # positional encoding
        self.positional_encoding = CustomPositionalEncoding(**positional_encoding)
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        tpv_queries_hw = tpv_queries_hw.unsqueeze(0).repeat(bs, 1, 1) #bs hw c
